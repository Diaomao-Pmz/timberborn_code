...
namespace Timberborn.TutorialSystem
{
	...
	[Nullable(0)]
	[UsedImplicitly]
	public class BlinkingTutorialSpec : ComponentSpec, IEquatable<BlinkingTutorialSpec>
	{
		...
		protected override Type EqualityContract
		{
			...
			get
			{
				return typeof(BlinkingTutorialSpec);
			}
		}
		...
		public override string ToString()
		{
			...
			stringBuilder.Append("BlinkingTutorialSpec");
		...
		[NullableContext(2)]
		[CompilerGenerated]
		public static bool operator !=(BlinkingTutorialSpec left, BlinkingTutorialSpec right)
		{
			return !(left == right);
		}
		...
		{
			return this.Equals(obj as BlinkingTutorialSpec);
		}
		...
		[NullableContext(2)]
		[CompilerGenerated]
		public virtual bool Equals(BlinkingTutorialSpec other)
		{
		...
		[CompilerGenerated]
		protected BlinkingTutorialSpec(BlinkingTutorialSpec original) : base(original)
		{
		}

		// Token: 0x06000012 RID: 18 RVA: 0x000021C0 File Offset: 0x000003C0
		public BlinkingTutorialSpec()
		{
		}
	}
}
