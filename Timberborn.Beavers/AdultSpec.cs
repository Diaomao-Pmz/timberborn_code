...
namespace Timberborn.Beavers
{
	...
	[NullableContext(1)]
	[Nullable(0)]
	public class AdultSpec : ComponentSpec, IEquatable<AdultSpec>
	{
		...
		public override string ToString()
		{
			...
			stringBuilder.Append("AdultSpec");
		...
		[NullableContext(2)]
		[CompilerGenerated]
		public static bool operator !=(AdultSpec left, AdultSpec right)
		{
			return !(left == right);
		}
		...
		{
			return this.Equals(obj as AdultSpec);
		}
		...
		[NullableContext(2)]
		[CompilerGenerated]
		public virtual bool Equals(AdultSpec other)
		{
		...
		[CompilerGenerated]
		protected AdultSpec(AdultSpec original) : base(original)
		{
		}
